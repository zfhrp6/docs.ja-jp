...
-   [WIF の「方法」のインデックス](../../../docs/framework/security/wif-how-tos-index.md)  
    ...
    -   [方法: Windows 認証を使用するクレーム対応 ASP.NET アプリケーションをビルドする](../../../docs/framework/security/how-to-build-claims-aware-aspnet-app-using-windows-authentication.md)  
    ...
    -   [方法: メッセージ リプレイ検出を有効にする](../../../docs/framework/security/how-to-enable-token-replay-detection.md)  
