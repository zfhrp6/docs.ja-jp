...
## <a name="gamepiece-class"></a>GamePiece クラス  
 次のコードは、**GamePiece** クラス全体を示します。  
...
## <a name="gamepiececollection-class"></a>GamePieceCollection クラス  
 次のコードは、**GamePieceCollection** クラス全体を示します。  
...
## <a name="game1-class"></a>Game1 クラス  
 次のコードは、**Game1** クラス全体を示します。  
