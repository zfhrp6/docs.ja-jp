---
title: ".NET Framework のリフレクション | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "アセンブリ [.NET Framework], リフレクション"
  - "Assembly クラス, リフレクション"
  - "共通言語ランタイム, リフレクション"
  - "ConstructorInfo クラス, リフレクション"
  - "探索 (実行時に型情報を)"
  - "EventInfo クラス, リフレクション"
  - "FieldInfo クラス, リフレクション"
  - "MethodInfo クラス, リフレクション"
  - "Module クラス, リフレクション"
  - "モジュール, リフレクション"
  - "ParameterInfo クラス, リフレクション"
  - "PropertyInfo クラス, リフレクション"
  - "リフレクション"
  - "リフレクション, 概要 (リフレクションの)"
  - "ランタイム, リフレクション"
  - "型ブラウザー"
...
|[型の動的な読み込みおよび使用](../../../docs/framework/reflection-and-codedom/dynamically-loading-and-using-types.md)|遅延バインディングをサポートするリフレクション カスタム バインディング インターフェイスについて説明します。|  
