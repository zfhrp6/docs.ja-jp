---
title: "方法へまたは: ネットワーク追跡をコンフィギュレーションします。 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "app.config ファイル, ネットワーク追跡"
  - "アプリケーション構成ファイル, ネットワーク追跡"
  - "構成ファイル [.NET Framework], ネットワーク追跡"
  - "書式指定 [.NET Framework], ネットワーク追跡"
  - "レベル属性"
  - "ネットワーク追跡, 構成"
  - "セキュリティ レベルのトレース出力"
  - "ソケット, トレース出力"
...
---
# 方法へまたは: ネットワーク追跡をコンフィギュレーションします。
アプリケーションまたはコンピューターの構成ファイルには、ネットワークのトレースの形式と内容を決定する設定が保持されます。 この手順に従う前に、トレースが有効になっていることを確認します。 トレースを有効にする方法については、「[ネットワークのトレースの有効化](../../../docs/framework/network-programming/enabling-network-tracing.md)」を参照してください。  
...
## 参照  
 ...
 [実装とトレースの概要](http://msdn.microsoft.com/ja-jp/e924e57c-33cf-4b0e-9e7f-a45d13e38f2c)