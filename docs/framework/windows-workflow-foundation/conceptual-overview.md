...
このセクションには、Windows Workflow Foundation (WF) の背後にあるのより大きな概念について説明するトピックのセットが含まれています。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [Windows Workflow の基本概念](../../../docs/framework/windows-workflow-foundation/fundamental-concepts.md)  
 一部の開発者にとっては耳慣れない Windows Workflow Foundation 開発で使用される基本的な概念について説明します。  
  
 [Windows Workflow のアーキテクチャ](../../../docs/framework/windows-workflow-foundation/architecture.md)  
 Windows Workflow Foundation 開発で使用されるコンポーネントをについて説明します。
