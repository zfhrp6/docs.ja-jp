...
1.  永続性データベースを設定します。  
    ...
    2.  [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] ディレクトリ \(C:\\Windows\\Microsoft.NET\\Framework\\v4.X\\\) に移動します。  
...
2.  [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] アイコンを右クリックして **\[管理者として実行\]** をクリックし、昇格されたアクセス許可を使用して [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] を実行します。  
