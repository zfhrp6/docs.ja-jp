---
title: "エラーの送信と処理 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
4.  サービス プロジェクトを実行します。  
    ...
    1.  **ソリューション エクスプローラー**で `FaultService` プロジェクトを右クリックし、**\[スタートアップ プロジェクトに設定\]** を選択します。  
  
    2.  Ctrl キーを押しながら、F5 キーを押します。  
  
5.  [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] アイコンを右クリックして **\[管理者として実行\]** をクリックし、昇格されたアクセス許可で [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] の別のコピーを開きます。  
  
6.  Faults.sln ソリューション ファイルを開きます。  
  
7.  クライアント プロジェクトを実行します。  
  
    1.  **ソリューション エクスプローラー**で `FaultClient` プロジェクトを右クリックして **\[スタートアップ プロジェクトに設定\]** をクリックします。  
