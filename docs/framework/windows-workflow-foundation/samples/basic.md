...
## このセクションの内容  
 ...
 [!INCLUDE[wf](../../../../includes/wf-md.md)] 式を示すサンプルが含まれます。  
 ...
 [トランザクション](../../../../docs/framework/windows-workflow-foundation/samples/basic-transactions.md)  
 ワークフロー トランザクションを示すサンプルが含まれます。  
  
 [検証](../../../../docs/framework/windows-workflow-foundation/samples/validation.md)  
 [!INCLUDE[wf2](../../../../includes/wf2-md.md)] での検証を示すサンプルが含まれます。  
