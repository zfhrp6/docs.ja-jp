...
## このセクションの内容  
 ...
 <xref:System.ServiceModel.Activities.SendParameters> および <xref:System.ServiceModel.Activities.ReceiveParameters> アクティビティの使用法を示します。  
 ...
 [Send によるチャネル キャッシュ](../../../../docs/framework/windows-workflow-foundation/samples/channel-caching-with-send.md)  
 <xref:System.ServiceModel.Activities.SendMessageChannelCache> の使用方法を示します。  
