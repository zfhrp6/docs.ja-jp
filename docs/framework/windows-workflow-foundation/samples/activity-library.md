---
title: "アクティビティ ライブラリ | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## このセクションの内容  
 ...
 Policy4 アクティビティで [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] \(WF 3.5\) <xref:System.Workflow.Activities.Rules.RuleSet> オブジェクト内の [!INCLUDE[wf2](../../../../includes/wf2-md.md)] を、WF 3.5 に付属しているルール エンジンを使用して [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] \(WF 4.5\) の [!INCLUDE[wf2](../../../../includes/wf2-md.md)] で直接使用できるようにする方法を示します。  
 ...
 データベースにアクセスして情報を取得または変更できるアクティビティを作成する方法と、[ADO.NET](http://go.microsoft.com/fwlink/?LinkId=166081) を使用してデータベースにアクセスする方法を示します。  
 ...
 ExternalizedPolicy4 アクティビティで [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] \(WF 3.5\) <xref:System.Workflow.Activities.Rules.RuleSet> オブジェクト内の既存の [!INCLUDE[wf2](../../../../includes/wf2-md.md)] を、WF 3.5 に付属しているルール エンジンを使用して [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)] \(WF 4.5\) の [!INCLUDE[wf2](../../../../includes/wf2-md.md)] で直接実行できるようにする方法を示します。  
