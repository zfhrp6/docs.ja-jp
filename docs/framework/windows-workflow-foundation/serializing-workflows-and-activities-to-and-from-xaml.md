...
```  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)][C# 式](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md)です。  
