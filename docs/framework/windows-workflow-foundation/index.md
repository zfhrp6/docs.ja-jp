...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [Windows Workflow Foundation の新機能](../../../docs/framework/windows-workflow-foundation/whats-new.md)  
 以前のバージョンからの開発パラダイムの変更点について説明します。  
  
 [.NET 4.5 での Windows Workflow Foundation の新機能](../../../docs/framework/windows-workflow-foundation/whats-new-in-wf-in-dotnet.md)  
 [!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] の Windows Workflow Foundation の新機能について説明します。  
  
 [Windows Workflow Foundation の機能仕様](../../../docs/framework/windows-workflow-foundation/feature-specifics.md)  
 ...
 [Windows Workflow のサンプル](../../../docs/framework/windows-workflow-foundation/samples/index.md)  
