...
[!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] 提供、<xref:System.Activities.Statements.Interop>を基になっている、ワークフロー内でアクティビティから派生するアクティビティを実行するアクティビティ<xref:System.Activities.Activity>です。 詳細については、次を参照してください。、[移行ガイダンス](../../../docs/framework/windows-workflow-foundation/migration-guidance.md)セクションです。  
