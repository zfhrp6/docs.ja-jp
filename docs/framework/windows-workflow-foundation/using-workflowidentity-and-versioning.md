...
##  <a name="UsingWorkflowIdentity"></a><span data-ttu-id="8ad61-113">WorkflowIdentity の使用</span><span class="sxs-lookup"><span data-stu-id="8ad61-113">Using WorkflowIdentity</span></span>  
...
###  <a name="SxS"></a><span data-ttu-id="8ad61-129">WorkflowIdentity を使用して、サイド バイ サイド実行</span><span class="sxs-lookup"><span data-stu-id="8ad61-129">Side-by-side Execution using WorkflowIdentity</span></span>  
...
##  <a name="UpdatingWF4PersistenceDatabases"></a><span data-ttu-id="8ad61-147">ワークフローのバージョン管理をサポートするには、.NET Framework 4 永続性データベースをアップグレードします。</span><span class="sxs-lookup"><span data-stu-id="8ad61-147">Upgrading .NET Framework 4 Persistence Databases to Support Workflow Versioning</span></span>  
...
###  <a name="ToUpgrade"></a><span data-ttu-id="8ad61-153">データベース スキーマをアップグレードするには</span><span class="sxs-lookup"><span data-stu-id="8ad61-153">To upgrade the database schema</span></span>  
