...
|----------------|---------------|  
|メニュー バー<br /><br /> -   MenuItem \(1 個以上\)<br />-   その他のコントロール \(0 個以上\)|メニュー バー<br /><br /> -   MenuItem \(1 個以上\)<br />-   その他のコントロール \(0 個以上\)|  
