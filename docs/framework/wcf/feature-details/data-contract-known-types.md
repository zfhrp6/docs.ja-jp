---
title: "既知のデータ コントラクト型 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   送信データ コントラクトが、予想データ コントラクトから派生する場合。[!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][データ コントラクトの等価性](../../../../docs/framework/wcf/feature-details/data-contract-equivalence.md)」の継承に関するセクションを参照してください。 この場合、送信されるデータには、受信エンドポイントで予想しているデータ コントラクトが含まれません。  
