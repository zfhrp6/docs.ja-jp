...
-   <xref:System.ServiceModel.NetMsmqBinding>. 他の [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] エンドポイントとのキュー ベースの通信を実行するのに適した [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] バインディング。  
