...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 2 つの標準について説明します<xref:System.ServiceModel>属性を使用すると、WCF サービスのトランザクションの動作を構成します。  
 ...
 WCF では、トランザクション アプリケーションのトラブルシューティングに管理および診断機能を使用する方法について説明します。  
 ...
 エンタープライズ サービスを使用するコードを WCF サービスを統合する方法について説明します。
