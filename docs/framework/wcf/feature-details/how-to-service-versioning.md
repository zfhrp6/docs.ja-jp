---
title: "サービスのバージョンを管理する方法 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
4.  受信メッセージをフィルター テーブルに含まれているフィルターと照合して評価するには、ルーティング動作を使用して、フィルター テーブルをサービス エンドポイントと関連付ける必要があります。次の例は、filterTable1 をサービス エンドポイントと関連付ける方法を示しています。  
