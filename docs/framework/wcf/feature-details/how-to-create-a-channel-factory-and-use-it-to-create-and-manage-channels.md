...
## <a name="example"></a><span data-ttu-id="4251a-104">例</span><span class="sxs-lookup"><span data-stu-id="4251a-104">Example</span></span>  
 <span data-ttu-id="4251a-105">次のコードは、チャネル ファクトリを作成および使用して、チャネルを作成および管理する方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="4251a-105">The following code shows how to create a channel factory and use it to create and manage channels.</span></span>  
  
 [!code-csharp[S_CustomAuthentication#1](../../../../samples/snippets/csharp/VS_Snippets_CFX/s_customauthentication/cs/instance.cs#1)]  
  
## <a name="see-also"></a><span data-ttu-id="4251a-106">関連項目</span><span class="sxs-lookup"><span data-stu-id="4251a-106">See Also</span></span>  
