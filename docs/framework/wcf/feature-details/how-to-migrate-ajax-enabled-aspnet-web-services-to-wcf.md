...
-   トレースなどの [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] の機能の利点が得られます。  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]公開する、 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] AJAX 対応エンドポイントを介してサービスを参照してください、[する方法: ASP.NET AJAX エンドポイントを追加する構成を使用する](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md)トピックです。  
...
|<xref:System.DBNull.Value> のシリアル化|{} (or {"__type":"#System"})|Null|  
