...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [.NET リモート処理アプリケーションは、WCF に移行します。](../../../../docs/framework/wcf/feature-details/migrating-net-remoting-applications-to-wcf.md)  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] を [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] リモート処理と共に使用する方法を説明します。  
  
 [Web との相互運用サービス 3.0 の機能強化](../../../../docs/framework/wcf/feature-details/interoperability-with-web-services-enhancements-3-0.md)  
 ...
 [WCF に移行する ASP.NET Web サービス](../../../../docs/framework/wcf/feature-details/migrating-aspnet-web-services-to-wcf.md)  
 ...
 [POX アプリケーションとの相互運用](../../../../docs/framework/wcf/feature-details/interoperability-with-pox-applications.md)  
