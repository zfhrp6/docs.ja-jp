---
title: "コア通信 : HTTP/HTTPS トランスポート チャネル | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Hosting\_SslSettingsMisconfigured|指定されたサービスの SSL \(Secure Sockets Layer\) 設定が、インターネット インフォメーション サービスの SSL 設定と一致しません。|  
...
|HttpRegistrationAccessDenied|HTTP は指定された URL を登録できません。  プロセスにこの名前空間へのアクセス権がありません \(詳細については、http:\/\/msdn.microsoft.com\/library\/default.asp?url\=\/library\/http\/http\/namespace\_reservations\_registrations\_and\_routing.asp を参照してください\)。|  
