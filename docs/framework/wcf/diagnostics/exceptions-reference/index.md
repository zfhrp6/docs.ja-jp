...
ここでは、次のエリアで [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] によって生成されるすべての例外を示します。  
 ...
 [MSMQ 統合トランスポート](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-integration-transport.md)  
  
 [MSMQ トランスポート](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-transport.md)  
  
 [信頼できるメッセージング](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/reliable-messaging.md)  
