...
## 説明  
 ...
 このトレースは、`System.ServiceModel` トレース ソースが情報レベルまたは詳細レベルで有効な場合に、[!INCLUDE[indigo2](../../../../../includes/indigo2-md.md)] メッセージが受信されるときに出力されます。このトレースはアクティビティのグラフ ビューでメッセージの相関矢印を表示するために必要です。  
