...
このセクションには、[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] の Windows サービスのメッセージ セキュリティ バインディングを示すサンプルが含まれています。  
  
## <a name="in-this-section"></a>このセクションの内容  
 [メッセージ セキュリティ匿名](../../../../docs/framework/wcf/samples/message-security-anonymous.md)  
 このサンプルでは、クライアント認証を行わないでメッセージ レベルのセキュリティを使用する [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] アプリケーションを実装する方法を示します。このアプリケーションでは、サーバーの X.509 証明書を使用するサーバー認証が必要です。  
