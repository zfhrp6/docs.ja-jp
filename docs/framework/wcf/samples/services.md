...
## このセクションの内容  
 ...
 [構成チャネル ファクトリ](../../../../docs/framework/wcf/samples/configuration-channel-factory.md)  
 ...
 コードを使用するサービスについて、構成で `wsHttpBinding` バインディングを定義する代わりに <xref:System.ServiceModel.WsHttpBinding> を定義する方法を示します。  
 ...
 サービス実装で Reentrant 同時実行モードを使用する方法を示します。