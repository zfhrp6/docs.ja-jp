---
title: "トランザクション バッチ | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 使用例  
 ...
 このサンプルでは、複数のサービス操作を実行する際に単一のトランザクションを使用します。  これはパフォーマンス最適化機能としてのみ使用されるもので、アプリケーションのセマンティクスには影響しません。  このサンプルは、「[トランザクション MSMQ バインディング](../../../../docs/framework/wcf/samples/transacted-msmq-binding.md)」に基づいています。  
