...
このセクションには、Windows Communication Foundation (WCF) でカスタム トランスポートを示すサンプルが含まれています。  
  
## <a name="in-this-section"></a>このセクションの内容  
 [UDP アクティベーション](../../../../docs/framework/wcf/samples/udp-activation.md)  
 拡張する方法を示します、[トランスポート: UDP](../../../../docs/framework/wcf/samples/transport-udp.md) Windows プロセス アクティブ化サービス (WAS) を使用するプロセス アクティブ化をサポートするサンプルです。  
