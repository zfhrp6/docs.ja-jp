...
この例を使用する方法を示しています、<xref:System.Windows.Media.Imaging.BitmapImage>のソースとして、<xref:System.Windows.Controls.Image>で制御[!INCLUDE[TLA#tla_xaml](../../../../includes/tlasharptla-xaml-md.md)]です。  
