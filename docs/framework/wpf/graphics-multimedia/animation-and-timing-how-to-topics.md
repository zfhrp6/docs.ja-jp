---
title: "アニメーションおよびタイミングに関する「方法」トピック | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
以下のトピックでは、[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] のアニメーションおよびタイミング システムをアプリケーションで使用する方法について説明します。  
...
## このセクションの内容  
 ...
 [How to: Remove a Storyboard](http://msdn.microsoft.com/ja-jp/7fe39531-de2f-46a0-a69f-b783d04235ee)  
