...
ms.locfileid: "33560852"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="58cbf-102">方法 : BitmapSource をインデックス付きピクセル形式に変換する</span><span class="sxs-lookup"><span data-stu-id="58cbf-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="58cbf-103">この例では、変換、<xref:System.Windows.Media.Imaging.BitmapSource>インデックス付きピクセル形式。</span><span class="sxs-lookup"><span data-stu-id="58cbf-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="58cbf-104">例</span><span class="sxs-lookup"><span data-stu-id="58cbf-104">Example</span></span>  
