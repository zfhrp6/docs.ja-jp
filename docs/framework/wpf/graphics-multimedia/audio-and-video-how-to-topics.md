---
title: "オーディオとビデオに関する「方法」トピック | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
以下のトピックでは、<xref:System.Windows.Controls.MediaElement> を使用してアプリケーションにオーディオとビデオのコンテンツを統合する方法について説明します。  
  
## このセクションの内容  
 [How to: Add an Element Dynamically](http://msdn.microsoft.com/ja-jp/d00f258a-7973-4de7-bc54-a3fc1f638419)  
