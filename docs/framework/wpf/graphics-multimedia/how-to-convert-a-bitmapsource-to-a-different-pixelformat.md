...
## <a name="example"></a><span data-ttu-id="76ecf-104">例</span><span class="sxs-lookup"><span data-stu-id="76ecf-104">Example</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="76ecf-105">関連項目</span><span class="sxs-lookup"><span data-stu-id="76ecf-105">See Also</span></span>  
 [<span data-ttu-id="76ecf-106">イメージングの概要</span><span class="sxs-lookup"><span data-stu-id="76ecf-106">Imaging Overview</span></span>](../../../../docs/framework/wpf/graphics-multimedia/imaging-overview.md)
