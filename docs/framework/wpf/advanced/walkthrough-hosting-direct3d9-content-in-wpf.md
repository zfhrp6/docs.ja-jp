...
-   新しい WPF アプリケーション プロジェクトを作成するには名前付き Visual c# で`D3DHost`です。 詳細については、次を参照してください。[する方法: 新しい WPF アプリケーション プロジェクトを作成する](http://msdn.microsoft.com/en-us/1f6aea7a-33e1-4d3f-8555-1daa42e95d82)です。  
