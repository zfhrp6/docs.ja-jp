...
-   印刷のパフォーマンス向上の両方の .NET Framework と[!INCLUDE[TLA#tla_win32](../../../../includes/tlasharptla-win32-md.md)]ベースのアプリケーションです。  
