...
helpviewer_keywords: 
  - "イベント, ウィンドウ"
  - "Windows Presentation Foundation, イベント"
  - "WPF, イベント"
...
---
# イベント (WPF)
[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] では、アプリケーションの要素ツリー内のさまざまなリスナー上に存在するハンドラーを呼び出すことができる[ルーティング イベント](GTMT)が導入されています。  
