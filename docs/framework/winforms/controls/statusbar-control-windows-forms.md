...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 一般的な概念が導入されています、<xref:System.Windows.Forms.StatusBar>コントロールで、フォーカスがあるコントロールの関連情報を表示することができます。  
 ...
 処理する方法について説明します<xref:System.Windows.Forms.Control.Click>からのイベントが発生、<xref:System.Windows.Forms.StatusBar>コントロール。  
  
 [方法: ステータス バー パネルのサイズを設定する](../../../../docs/framework/winforms/controls/how-to-set-the-size-of-status-bar-panels.md)  
 幅を制御およびステータス バー パネルの動作の実行時にサイズを変更するプロパティの詳細を示します。  
...
## <a name="reference"></a>参照  
 ...
 置き換えする機能を追加、<xref:System.Windows.Forms.StatusBar>コントロール。  
