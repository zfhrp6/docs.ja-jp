---
title: "方法 : アプリケーションの ToolStrip レンダラーを設定する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Renderer プロパティ [Windows フォーム]"
  - "ツール バー [Windows フォーム], カスタマイズ"
...
---
# 方法 : アプリケーションの ToolStrip レンダラーを設定する
...
## 使用例  
 ...
 カスタム メニュー項目の表示を確認するには、<xref:System.Windows.Forms.ComboBox> コントロールから <xref:System.Windows.Forms.MenuStrip> オプションを選択して、**\[適用\]** をクリックし、**\[ファイル\]** メニュー項目を開きます。  
...
[!code-vb[System.Windows.Forms.ToolStrip.Misc#70](../../../../samples/snippets/visualbasic/VS_Snippets_Winforms/System.Windows.Forms.ToolStrip.Misc/VB/Program.vb#70)]  
 ...
 アプリケーションのすべての <xref:System.Windows.Forms.ToolStrip> コントロールにカスタム レンダラーを適用するよう <xref:System.Windows.Forms.ToolStripManager.Renderer%2A?displayProperty=fullName> プロパティを設定します。  
  
 カスタム レンダラーを各 <xref:System.Windows.Forms.ToolStrip> コントロールに適用するよう <xref:System.Windows.Forms.ToolStrip.Renderer%2A?displayProperty=fullName> プロパティを設定します。  
