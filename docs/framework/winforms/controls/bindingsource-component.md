---
title: "BindingSource コンポーネント | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "BindingSource コンポーネント [Windows フォーム]"
  - "データ バインド, Windows フォーム"
  - "Windows フォーム, データ バインディング コントロール"
...
## このセクションの内容  
 ...
 [方法 : Windows フォーム BindingSource を使用した項目の追加をカスタマイズする](../../../../docs/framework/winforms/controls/how-to-customize-item-addition-with-the-windows-forms-bindingsource.md)  
...
## 関連項目  
 ...
 「[Visual Studio でのデータへのコントロールのバインド](../Topic/Bind%20controls%20to%20data%20in%20Visual%20Studio.md)」も参照してください。