...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 特定の列をコントロールに表示されないようにする方法について説明します。  
 ...
 列ヘッダーをコントロールに表示されないようにする方法について説明します。  
 ...
 説明 1 つまたは複数の隣接する列をスクロールできないようにする方法です。  
 ...
 ユーザーがコントロール内の特定の列を編集することを防止する方法について説明します。  
 ...
 ユーザーが行を追加することを防止するコントロールの下部にある新しいレコードの行を削除する方法について説明します。 ユーザーが行を削除することを防止する方法についても説明します。  
 ...
 現在フォーカスがコントロール内のセルにアクセスする方法をについて説明します。  
