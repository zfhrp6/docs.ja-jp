---
title: "コントロールの種類に関するアドバイス | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "カスタム コントロール [Windows フォーム], 種類"
  - "継承, Windows フォーム カスタム コントロール"
  - "ユーザー コントロール [Windows フォーム], 使用する時期"
...
> [!NOTE]
>  Web フォームで使用するコントロールを作成する場合は、「[Developing Custom ASP.NET Server Controls](../Topic/Developing%20Custom%20ASP.NET%20Server%20Controls.md)」を参照してください。  
