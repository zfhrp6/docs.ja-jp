---
title: "方法 : ContextMenuStrip のチェックの余白とイメージの余白を設定する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "コンテキスト メニュー, 設定 (チェックの余白とイメージの余白を)"
  - "ContextMenuStrips, 設定 (チェックの余白とイメージの余白を)"
  - "マージン, 設定 (Windows フォームの ContextMenuStrips のチェックの余白とイメージの余白を)"
...
---
# 方法 : ContextMenuStrip のチェックの余白とイメージの余白を設定する
