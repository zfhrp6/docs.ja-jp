---
title: "方法 : Windows フォームの BindingNavigator コントロールを使用して DataSet を移動する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "BindingNavigator コントロール [Windows フォーム], 移動 (データセット内を)"
  - "データセット [Windows フォーム], 移動"
