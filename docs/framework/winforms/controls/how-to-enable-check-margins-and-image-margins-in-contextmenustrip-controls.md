---
title: "方法 : ContextMenuStrip コントロールでチェックの余白とイメージの余白を有効にする | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "ShowCheckMargin プロパティ [Windows フォーム]"
  - "ShowImageMargin プロパティ [Windows フォーム]"
  - "ツール バー [Windows フォーム]"
...
[!code-vb[System.Windows.Forms.ToolStrip.Misc#60](../../../../samples/snippets/visualbasic/VS_Snippets_Winforms/System.Windows.Forms.ToolStrip.Misc/VB/Program.vb#60)]  
 ...
 <xref:System.Windows.Forms.ToolStripDropDownMenu.ShowCheckMargin%2A?displayProperty=fullName> プロパティと <xref:System.Windows.Forms.ToolStripDropDownMenu.ShowImageMargin%2A?displayProperty=fullName> プロパティを設定して、チェック マークとカスタム イメージがメニュー項目に表示されるタイミングを指定します。  
