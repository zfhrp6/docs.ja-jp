---
title: "方法 : ToolStripPanel を MDI で使用する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "MDI, 使用 (ToolStripPanels を) [Windows フォーム]"
  - "ツール バー [Windows フォーム], 使用 (MDI 用に)"
  - "ToolStripPanel コントロール [Windows フォーム], 使用 (MDI 用に)"
