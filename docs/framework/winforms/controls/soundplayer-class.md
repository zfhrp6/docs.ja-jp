---
title: "SoundPlayer クラス | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 関連項目  
 ...
 「[My.Computer オブジェクト](http://msdn.microsoft.com/library/11bxex12\(v=vs.110\))」または「[My.Computer オブジェクト](http://msdn.microsoft.com/library/11bxex12\(v=vs.120\))」も参照してください。