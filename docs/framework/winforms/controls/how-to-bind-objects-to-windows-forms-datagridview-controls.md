---
title: "方法 : オブジェクトを Windows フォーム DataGridView コントロールにバインドする | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "データ グリッド, オブジェクトのバインディング"
  - "DataGridView コントロール [Windows フォーム], オブジェクトのバインディング"
  - "オブジェクトのバインディング, DataGridView コントロール"
