---
title: "HScrollBar コントロールおよび VScrollBar コントロール (Windows フォーム) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "HScrollBar コントロール [Windows フォーム]"
  - "Scroll Bar コントロール [Windows フォーム]"
  - "スクロール バー"
  - "スクロール バー, Windows フォーム"
  - "VScrollBar コントロール [Windows フォーム]"
...
## このセクションの内容  
 [HScrollBar コントロールと VScrollBar コントロールの概要](../../../../docs/framework/winforms/controls/hscrollbar-and-vscrollbar-controls-overview-windows-forms.md)  
