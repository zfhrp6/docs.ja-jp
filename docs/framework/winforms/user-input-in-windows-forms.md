---
title: "Windows フォームでのユーザー入力 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "キーボード入力, 使用 (Windows フォームで)"
  - "キーボード, キーボード入力"
  - "マウス入力, 使用 (Windows フォームで)"
  - "Windows フォーム, ユーザー入力"
...
## 関連項目  
 「[Windows フォーム内でのイベント ハンドラーの作成](http://msdn.microsoft.com/library/dacysss4\(v=vs.110\))」も参照してください。