...
# <a name="installing-the-net-framework-on-windows-8"></a>Windows 8 への .NET Framework のインストール

Windows 8 でアプリケーションを実行するために .NET Framework が必要になることがあります。 このような場合は次の手順を実行します。 必要な .NET Framework のバージョンによって手順は異なります。

## <a name="net-framework-462"></a>.NET Framework 4.6.2

Windows 8 には、[.NET Framework 4.6.2](https://go.microsoft.com/fwlink/?linkid=845529&source=dotnetdocs) 以降をインストールできます。 
