---
title: "Caspol.exe (コード アクセス セキュリティ ポリシー ツール) | Microsoft ドキュメント"
ms.custom: 
ms.date: 03/30/2017
...
## <a name="remarks"></a>コメント  
 ...
 セキュリティ ポリシーの詳細、およびランタイムがコードに与えるアクセス許可を決定する方法については、「[セキュリティ ポリシーの管理](http://msdn.microsoft.com/en-us/d754e05d-29dc-4d3a-a2c2-95eaaf1b82b9)」を参照してください。  
