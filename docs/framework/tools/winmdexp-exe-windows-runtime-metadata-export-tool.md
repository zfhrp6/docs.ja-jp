---
title: "Winmdexp.exe (Windows ランタイム メタデータのエクスポート ツール) | Microsoft ドキュメント"
ms.custom: 
ms.date: 03/30/2017
