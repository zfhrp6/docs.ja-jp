---
title: "Tlbimp.exe (タイプ ライブラリ インポーター) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|**\/sysarray**|ツールが COM スタイル SafeArray をマネージ [System.Array クラス](frlrfSystemArrayClassTopic)型としてインポートするように指定します。|  
...
|**\/transform:** *transformname*|*transformname* パラメーターで指定されたようにメタデータを変換します。<br /><br /> ディスパッチ専用インターフェイスに対するメソッドの \[out, retval\] パラメーターを戻り値に変換するには、*transformname* パラメーターに **dispret** を指定します。<br /><br /> このオプションの詳細については、このトピックの下記の例を参照してください。|  
...
## 参照  
 ...
 [Attributes for Importing Type Libraries into Interop Assemblies](http://msdn.microsoft.com/ja-jp/81e587b8-393f-43e1-9add-c4b05e65cbfd)   
