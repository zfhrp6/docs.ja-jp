---
title: ".NET Framework ツール | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - ".NET Framework, ツール"
  - "コマンド ライン, .NET Framework ツール"
  - "実行 (.NET Framework ツールを)"
  - "ツール [.NET Framework]"
...
## 関連項目  
 ...
 isXPS 適合性ツール \(isXPS.exe\)、パフォーマンス プロファイリング ツール、XamlPad などのツールを含みます。XamlPad は Extensible Application Markup Language \(XAML\) 用の基本的なビジュアル エディターです。  
