---
title: "スレッド プール ETW イベント | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ETW, スレッド プール イベント (CLR)"
  - "スレッド プール イベント [.NET Framework]"
...
### ThreadPoolWorkerThreadStart および ThreadPoolWorkerThreadStop  
 次の表に、これらのイベントのキーワードとレベルを示します。 \(詳細については、「[CLR ETW キーワードおよびレベル](../../../docs/framework/performance/clr-etw-keywords-and-levels.md)」を参照してください\)。  
