...
## <a name="related-sections"></a>関連項目  
 ...
 [ストア アプリ用 .NET](http://msdn.microsoft.com/library/windows/apps/br230302.aspx)  
 Windows コンピューターとデバイスに展開できるストア アプリ用 .NET Framework のサポートについて説明します。  
  
 [Windows Phone Silverlight 用の .NET API](http://msdn.microsoft.com/library/windows/apps/xaml/jj207211\(v=vs.105\).aspx)  
