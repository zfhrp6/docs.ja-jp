---
title: ".NET Framework 4.5 を 4.6 からの移行の実行時の変更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="49910-102">.NET Framework 4.5 を 4.6 からの移行の実行時の変更</span><span class="sxs-lookup"><span data-stu-id="49910-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="49910-103">.NET Framework 4.5 から 4.6 へ移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="49910-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="49910-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="49910-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="49910-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="49910-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="49910-106">コア</span><span class="sxs-lookup"><span data-stu-id="49910-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="49910-107">データ</span><span class="sxs-lookup"><span data-stu-id="49910-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="49910-108">デバッガー</span><span class="sxs-lookup"><span data-stu-id="49910-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="49910-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="49910-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="49910-110">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="49910-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="49910-111">シリアル化</span><span class="sxs-lookup"><span data-stu-id="49910-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="49910-112">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="49910-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="49910-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="49910-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="49910-114">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="49910-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="49910-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="49910-115">Windows Presentation Foundation (WPF)</span></span>
