---
title: ".NET Framework 4.0 を 4.5 からの移行の実行時の変更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="3ca02-102">.NET Framework 4.0 を 4.5 からの移行の実行時の変更</span><span class="sxs-lookup"><span data-stu-id="3ca02-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3ca02-103">.NET Framework 4.0 から 4.5 へ移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="3ca02-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="3ca02-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3ca02-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3ca02-105">コア</span><span class="sxs-lookup"><span data-stu-id="3ca02-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3ca02-106">データ</span><span class="sxs-lookup"><span data-stu-id="3ca02-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3ca02-107">デバッガー</span><span class="sxs-lookup"><span data-stu-id="3ca02-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3ca02-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3ca02-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="3ca02-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="3ca02-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="3ca02-110">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="3ca02-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="3ca02-111">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="3ca02-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="3ca02-112">印刷</span><span class="sxs-lookup"><span data-stu-id="3ca02-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3ca02-113">シリアル化</span><span class="sxs-lookup"><span data-stu-id="3ca02-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="3ca02-114">Web アプリケーション</span><span class="sxs-lookup"><span data-stu-id="3ca02-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3ca02-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3ca02-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3ca02-116">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="3ca02-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3ca02-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3ca02-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3ca02-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3ca02-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3ca02-119">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="3ca02-119">XML, XSLT</span></span>
