...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a>.NET Framework 4.5.2 に 4.7 からの移行の実行時の変更

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

.NET Framework 4.5.2 に 4.7 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。
