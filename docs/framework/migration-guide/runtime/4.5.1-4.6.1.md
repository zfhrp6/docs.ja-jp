---
title: ".NET Framework 4.5.1 を 4.6.1 からの移行の実行時の変更"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="b3c1a-102">.NET Framework 4.5.1 を 4.6.1 からの移行の実行時の変更</span><span class="sxs-lookup"><span data-stu-id="b3c1a-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b3c1a-103">.NET Framework 4.5.1 を 4.6.1 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="b3c1a-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="b3c1a-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b3c1a-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b3c1a-105">コア</span><span class="sxs-lookup"><span data-stu-id="b3c1a-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b3c1a-106">データ</span><span class="sxs-lookup"><span data-stu-id="b3c1a-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b3c1a-107">デバッガー</span><span class="sxs-lookup"><span data-stu-id="b3c1a-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b3c1a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b3c1a-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="b3c1a-109">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="b3c1a-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b3c1a-110">シリアル化</span><span class="sxs-lookup"><span data-stu-id="b3c1a-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b3c1a-111">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="b3c1a-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b3c1a-112">ツール</span><span class="sxs-lookup"><span data-stu-id="b3c1a-112">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b3c1a-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b3c1a-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="b3c1a-114">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="b3c1a-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b3c1a-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b3c1a-115">Windows Presentation Foundation (WPF)</span></span>
