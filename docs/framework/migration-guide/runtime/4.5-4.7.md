...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="c8c92-102">.NET Framework 4.5 から 4.7 への移行に関するランタイム変更</span><span class="sxs-lookup"><span data-stu-id="c8c92-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c8c92-103">.NET Framework 4.5 から 4.7 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="c8c92-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="c8c92-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="c8c92-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="c8c92-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c8c92-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c8c92-106">コア</span><span class="sxs-lookup"><span data-stu-id="c8c92-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c8c92-107">データ</span><span class="sxs-lookup"><span data-stu-id="c8c92-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c8c92-108">デバッガー</span><span class="sxs-lookup"><span data-stu-id="c8c92-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c8c92-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c8c92-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c8c92-110">グローバリゼーション</span><span class="sxs-lookup"><span data-stu-id="c8c92-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="c8c92-111">JIT</span><span class="sxs-lookup"><span data-stu-id="c8c92-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c8c92-112">ネットワーキング</span><span class="sxs-lookup"><span data-stu-id="c8c92-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c8c92-113">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="c8c92-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c8c92-114">シリアル化</span><span class="sxs-lookup"><span data-stu-id="c8c92-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c8c92-115">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="c8c92-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c8c92-116">ツール</span><span class="sxs-lookup"><span data-stu-id="c8c92-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c8c92-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c8c92-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c8c92-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c8c92-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c8c92-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c8c92-119">Windows Workflow Foundation (WF)</span></span>
