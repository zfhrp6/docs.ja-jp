...
|----------------------------|-----------------|--------------|---------------------------------------|----------------------------------------------------|-----------------------------------------------------------|-----------------------------------------| 
|4.7.1|4|.NET 標準 2.0 のサポート。<br/> -Configuration ビルダー、実行時に構成ファイルの作成の許可をサポートします。<br/> ランタイム機能検出、定義済みの機能がランタイム環境でサポートされているかどうかを判断することができます。<br/> シリアル化可能な値の組。<br/> のガベージ コレクションのパフォーマンス向上。<br/> ポータブル Pdb をサポートします。<br/> 、対応しており sha-2<xref:System.Messaging.Message.HashAlgorithm%2A?displayProperty=nameWithType>です。<br/> ASP.NET cookie を使用した解析のサポート、<xref:System.Web.HttpCookie.TryParse%2A?displayProperty=nameWithType>メソッドです。<br/> Sha-2 ハッシュ ASP.NET フォーム認証の資格情報用のサポート。<br/> さまざまなユーザー補助の品質向上をアプリケーション開発者です。参照してください[、.NET Framework のユーザー補助機能の新機能](../whats-new/whats-new-in-accessibility.md)します。| | ✓ 10 秋作成者を更新します。 <br/> <br/> + 10 作成者を更新します。 <br/> + 10 Anniversary Update <br/> + 8.1 <br/> +7| + 2016 <br/> + 2012 R2 <br/> + 2012 <br/> + 2008 R2 SP1 |`Release` DWORD を使用:<br/><br/> 461308 (Windows 10 の作成者の更新プログラム) <br/> 461310 (すべての OS バージョン) <br/><br/> ([手順](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)に関するページを参照) 
