...
|3.5|2.0|- AJAX 対応の Web サイト<br />- LINQ<br />- 動的データ<br />-   [その他...](http://msdn.microsoft.com/library/ms171868\(v=vs.90\).aspx)|2008|✓ 10<br />✓ 8.1*<br />✓ 8\*<br />✓ 7<br />+ Vista|✓ 2008 R2 SP1*<br />+ 2012 R2<br />+ 2012<br />+ 2008 SP2<br />+ 2003|[手順](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)に関するページを参照|  
