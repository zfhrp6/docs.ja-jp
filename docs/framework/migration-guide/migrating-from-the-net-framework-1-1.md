...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, 移行 (.NET Framework 4.5 への)"
  - ".NET Framework 4.5, 移行 (1.1 から)"
...
-   「[.NET Framework 2.0 の互換性に影響する変更点](http://go.microsoft.com/fwlink/?LinkId=125263)」に記載されている、[!INCLUDE[net_v11_short](../../../includes/net-v11-short-md.md)] を対象とするアプリケーションに影響する可能性がある [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)] の変更点。  
