...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a>.NET Framework 4.5.2 に 4.7.1 からの移行の変更の再ターゲット

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

.NET Framework 4.5.2 に 4.7.1 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。
