---
title: ".NET Framework 4.5.2 に 4.6 からの移行の変更の再ターゲット"
ms.date: 05/19/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="bd51c-102">.NET Framework 4.5.2 に 4.6 からの移行の変更の再ターゲット</span><span class="sxs-lookup"><span data-stu-id="bd51c-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="bd51c-103">.NET Framework 4.5.2 に 4.6 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="bd51c-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="bd51c-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="bd51c-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="bd51c-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="bd51c-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="bd51c-106">コア</span><span class="sxs-lookup"><span data-stu-id="bd51c-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="bd51c-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="bd51c-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="bd51c-108">JIT</span><span class="sxs-lookup"><span data-stu-id="bd51c-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="bd51c-109">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="bd51c-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="bd51c-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="bd51c-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="bd51c-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="bd51c-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="bd51c-112">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="bd51c-112">XML, XSLT</span></span>
