...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-47"></a>.NET Framework 4.0 を 4.7 からの移行の変更の再ターゲット

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

.NET Framework 4.0 から 4.7 へ移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。
