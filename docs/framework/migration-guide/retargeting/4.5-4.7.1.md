---
title: ".NET Framework 4.5 に 4.7.1 からの移行の変更の再ターゲット |Microsoft ドキュメント"
ms.date: 10/09/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="55674-102">.NET Framework 4.5 に 4.7.1 からの移行の変更の再ターゲット</span><span class="sxs-lookup"><span data-stu-id="55674-102">Retargeting Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="55674-103">.NET Framework 4.5 から 4.7.1 へ移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="55674-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="55674-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="55674-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="55674-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="55674-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="55674-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="55674-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="55674-107">コア</span><span class="sxs-lookup"><span data-stu-id="55674-107">Core</span></span>
...
## <a name="jit"></a><span data-ttu-id="55674-108">JIT</span><span class="sxs-lookup"><span data-stu-id="55674-108">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="55674-109">MSBuild</span><span class="sxs-lookup"><span data-stu-id="55674-109">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="55674-110">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="55674-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="55674-111">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="55674-111">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="55674-112">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="55674-112">Visual Basic .NET</span></span>

[!include[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="wpf"></a><span data-ttu-id="55674-113">WPF</span><span class="sxs-lookup"><span data-stu-id="55674-113">WPF</span></span>

[!include[Accessibility improvements in WPF](~/includes/migration-guide/retargeting/wpf/accessibility-improvements-wpf.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="55674-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="55674-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="55674-115">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="55674-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="55674-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="55674-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="55674-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="55674-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="55674-118">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="55674-118">XML, XSLT</span></span>
