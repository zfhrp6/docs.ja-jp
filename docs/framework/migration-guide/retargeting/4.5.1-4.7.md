---
title: ".NET Framework 4.5.1 を 4.7 からの移行の変更の再ターゲット"
ms.date: 06/16/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-47"></a><span data-ttu-id="21a47-102">.NET Framework 4.5.1 を 4.7 からの移行の変更の再ターゲット</span><span class="sxs-lookup"><span data-stu-id="21a47-102">Retargeting Changes for Migration from .NET Framework 4.5.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="21a47-103">.NET Framework 4.5.1 を 4.7 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="21a47-103">If you are migrating from the .NET Framework 4.5.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="21a47-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="21a47-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="21a47-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="21a47-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="21a47-106">コア</span><span class="sxs-lookup"><span data-stu-id="21a47-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="21a47-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="21a47-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="21a47-108">JIT</span><span class="sxs-lookup"><span data-stu-id="21a47-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="21a47-109">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="21a47-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="21a47-110">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="21a47-110">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="21a47-111">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="21a47-111">Visual Basic .NET</span></span>

[!include[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="21a47-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="21a47-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="21a47-113">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="21a47-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="21a47-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="21a47-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="21a47-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="21a47-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="21a47-116">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="21a47-116">XML, XSLT</span></span>
