---
title: ".NET Framework 4.5.2 に 4.6.2 からの移行の変更の再ターゲット"
ms.date: 06/14/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="8872e-102">.NET Framework 4.5.2 に 4.6.2 からの移行の変更の再ターゲット</span><span class="sxs-lookup"><span data-stu-id="8872e-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="8872e-103">.NET Framework 4.5.2 に 4.6.2 から移行する場合は、アプリに影響するアプリケーションの互換性の問題について次のトピックを確認します。</span><span class="sxs-lookup"><span data-stu-id="8872e-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="8872e-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="8872e-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="8872e-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="8872e-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="8872e-106">コア</span><span class="sxs-lookup"><span data-stu-id="8872e-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="8872e-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="8872e-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="8872e-108">JIT</span><span class="sxs-lookup"><span data-stu-id="8872e-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="8872e-109">ネットワーク</span><span class="sxs-lookup"><span data-stu-id="8872e-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="8872e-110">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="8872e-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="8872e-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="8872e-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="8872e-112">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="8872e-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="8872e-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="8872e-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="8872e-114">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="8872e-114">XML, XSLT</span></span>
