...
> [!NOTE]
>  ユーザーと開発者のための .NET Framework の概要については、「[作業の開始](../../../docs/framework/get-started/index.md)」を参照してください。  .NET Framework をダウンロードするには、「[インストール ガイド](../../../docs/framework/install/guide-for-developers.md)」を参照してください。  
...
-   Windows Communication Foundation \(WCF\) を使用するサービス指向アプリケーション  「[WCF を使用したサービス指向アプリケーション](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)」を参照してください。  
  
-   Windows Workflow Foundation \(WF\) を使用するワークフロー対応アプリケーション  「[.NET Framework におけるワークフローの作成](http://msdn.microsoft.com/ja-jp/cbf3880f-dc7b-466d-b808-1109b1223f4a)」を参照してください。  
...
## 参照  
 ...
 [.NET Framework のサンプル](http://msdn.microsoft.com/ja-jp/177055f8-4a1f-43e7-aee6-995c196079b1)   
