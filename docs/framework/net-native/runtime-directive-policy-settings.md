---
title: "ランタイム ディレクティブ ポリシーの設定 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|`Excluded`|特定のプログラム要素についてポリシーを無効にすることを指定します。  たとえば、次のランタイム ディレクティブは、<br /><br /> `<Type Name="BusinessClasses.Person" Browse="Excluded" Dynamic="Excluded" />`<br /><br /> `Person` オブジェクトの参照、および動的なインスタンス化と変更のいずれにも、`BusinessClasses.Person` クラスのメタデータを使用できないことを示しています。|✓|✓|  
