---
title: ".NET Framework 4.7、4.6、および 4.5 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
.NET Framework のダウンロードの詳細については、「[.NET Framework のインストール](../../docs/framework/install/guide-for-developers.md)」を参照してください。  
