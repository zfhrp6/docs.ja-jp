...
|[NIB: How to: Delay Sign an Assembly \(Visual Studio\)](http://msdn.microsoft.com/ja-jp/cab63b7a-591e-4674-b236-d77cd29a79ea)|アセンブリを作成した後に厳密な名前でアセンブリに署名する方法について説明します。|  
