---
title: ".NET Framework データ プロバイダー | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] Data Provider for ODBC は、[!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] Data Provider for OLE DB に似たアーキテクチャを持っています。たとえば、ODBC Service コンポーネントへの呼び出しを行います。  
 ...
 ![データ プロバイダー](../../../../docs/framework/data/adonet/media/netdataproviders-bpuedev11.png "NETDataProviders\_bpuedev11")  
...
## EntityClient プロバイダー  
 EntityClient プロバイダーは、エンティティ データ モデル \(EDM\) に基づくデータ アクセスで使用されます。 他の .NET Framework データ プロバイダーとは異なり、データ ソースと直接やり取りしません。 代わりに Entity SQL を使用して、基になるデータ プロバイダーと通信します。 詳細については、「[EntityClient and Entity SQL](http://msdn.microsoft.com/ja-jp/49202ab9-ac98-4b4b-a05c-140e422bf527)」を参照してください。  
