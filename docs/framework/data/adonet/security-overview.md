...
### 脅威モデリング  
 システムがどのような攻撃に曝されているかを理解せずに、攻撃からシステムを保護することはできません。  ADO.NET アプリケーション上でセキュリティ違反の可能性およびその影響を調べるには、*脅威のモデリング*と呼ばれるセキュリティ上の脅威を評価するプロセスが必要です。  
...
|リソース|説明|  
|----------|--------|  
|MSDN セキュリティ デベロッパー センターの「[脅威のモデリング](http://go.microsoft.com/fwlink/?LinkId=98353)」サイト|脅威のモデリング プロセスを理解し、開発したアプリケーションの脅威モデルを構築するうえで役に立ちます。|  
...
|リソース|説明|  
|----------|--------|  
|[アプリケーションの保護](../Topic/Securing%20Applications.md)|一般的なセキュリティ トピックへのリンクが含まれています。  分散アプリケーション、Web アプリケーション、モバイル アプリケーション、およびデスクトップ アプリケーションを保護するためのトピックへのリンクも含まれています。|  
...
|[Code Access Security](http://msdn.microsoft.com/ja-jp/23a20143-241d-4fe5-9d9f-3933fd594c03)|.NET Framework の CAS について説明する追加のトピックへのリンクが含まれています。|  
...
|リソース|説明|  
|----------|--------|  
|[NIB: Security Policy Management](http://msdn.microsoft.com/ja-jp/d754e05d-29dc-4d3a-a2c2-95eaaf1b82b9)|セキュリティ ポリシーの作成と管理について説明します。|  
|[NIB: Security Policy Best Practices](http://msdn.microsoft.com/ja-jp/d49bc4d5-efb7-4caa-a2fe-e4d3cec63c05)|セキュリティ ポリシーの管理方法について説明したトピックへのリンクを提供します。|  
