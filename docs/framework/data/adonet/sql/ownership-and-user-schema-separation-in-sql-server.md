---
title: "SQL Server における所有権とユーザーとスキーマの分離 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|リソース|説明|  
|----------|--------|  
|SQL Server オンライン ブックの「[ユーザーとスキーマの分離](http://msdn.microsoft.com/library/ms190387.aspx)」|ユーザーとスキーマの分離によって導入された変更について説明します。  新しい動作とそれが所有権、カタログ ビュー、および権限に与える影響を取り上げています。|  
