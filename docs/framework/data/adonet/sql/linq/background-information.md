...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [Id キャッシュからオブジェクトを取得します。](../../../../../../docs/framework/data/adonet/sql/linq/retrieving-objects-from-the-identity-cache.md)  
 ID キャッシュからオブジェクトを取得するクエリについて説明します。  
  
 [LINQ to SQL でのセキュリティ](../../../../../../docs/framework/data/adonet/sql/linq/security-in-linq-to-sql.md)  
 ...
 [SQL CLR のカスタム型マッピング](../../../../../../docs/framework/data/adonet/sql/linq/sql-clr-custom-type-mappings.md)  
