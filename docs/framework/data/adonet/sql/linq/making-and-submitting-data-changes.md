...
## <a name="in-this-section"></a>このセクションの内容  
 [方法 : 行をデータベースに挿入する](../../../../../../docs/framework/data/adonet/sql/linq/how-to-insert-rows-into-the-database.md)  
 オブジェクト モデルにオブジェクトを追加することにより、データベースに行を挿入する方法について説明します。  
  
 [方法 : データベースの行を更新する](../../../../../../docs/framework/data/adonet/sql/linq/how-to-update-rows-in-the-database.md)  
 オブジェクト モデルのオブジェクトを更新することにより、データベースの行を更新する方法について説明します。  
  
 [方法 : 行をデータベースから削除する](../../../../../../docs/framework/data/adonet/sql/linq/how-to-delete-rows-from-the-database.md)  
 オブジェクト モデルのオブジェクトを削除することにより、データベースの行を削除する方法について説明します。  
  
 [方法 : データベースに変更内容を送信する](../../../../../../docs/framework/data/adonet/sql/linq/how-to-submit-changes-to-the-database.md)  
 ...
 [方法 : データベースを動的に作成する](../../../../../../docs/framework/data/adonet/sql/linq/how-to-dynamically-create-a-database.md)  
 ...
 オプティミスティック同時実行制御の問題に対処する方法について説明します。
