---
title: "SqlCommand の実行と SqlNotificationRequest | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# SqlCommand の実行と SqlNotificationRequest
...
### 例  
 次のコード フラグメントは、<xref:System.Data.Sql.SqlNotificationRequest> を作成し、それを <xref:System.Data.Sql.SqlCommand> に関連付ける方法を示しています。  
