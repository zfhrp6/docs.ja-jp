---
title: "メソッドベースのクエリ構文例: フィルター処理 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# メソッドベースのクエリ構文例: フィルター処理
このトピックでは、メソッド ベースのクエリ構文で、`Where` メソッドと `Where…Contains` メソッドを使用して、[AdventureWorks Sales Model](http://msdn.microsoft.com/ja-jp/f16cd988-673f-4376-b034-129ca93c7832) を照会する例を取り上げます。  `Where Contains` は[コンパイル済みクエリ](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md)の中では使用できないことに注意してください。  
