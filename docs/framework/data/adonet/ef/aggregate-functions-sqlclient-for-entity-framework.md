---
title: "集計関数 (Entity Framework 用 SqlClient) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|関数|説明|  
|--------|--------|  
|`AVG(` `expression` `)`|コレクション内の値の平均値を返します。<br /><br /> NULL 値は無視されます。<br /><br /> **引数**<br /><br /> `Int32`、`Int64`、`Double`、`Decimal`。<br /><br /> **戻り値**<br /><br /> `expression` の型。<br /><br /> **例**<br /><br /> [!code-csharp[DP EntityServices Concepts#SQLSERVER_AVG](../../../../../samples/snippets/csharp/VS_Snippets_Data/dp entityservices concepts/cs/entitysql.cs#sqlserver_avg)]
...
|---------------------|---------------------|---------------------|  
|[集約関数 \(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115906)|[集約関数 \(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkID=115903)|[集約関数 \(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115907)|  
