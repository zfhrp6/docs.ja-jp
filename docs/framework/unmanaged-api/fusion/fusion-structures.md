...
このセクションでは、fusion API が使用されるアンマネージ構造体について説明します。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 関連付けられているに関するオフセット情報が含まれています[IDENTITY_ATTRIBUTE](../../../../docs/framework/unmanaged-api/fusion/identity-attribute-structure.md)構造体。  
