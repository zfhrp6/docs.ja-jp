...
## [プロファイル環境を設定します。](setting-up-a-profiling-environment.md)
## [CLR プロファイラーと Windows ストア アプリ](clr-profilers-and-windows-store-apps.md)
...
## [プロファイリング グローバル静的関数](profiling-global-static-functions.md)
