...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 サービスと .NET Framework 環境でプロファイルをサポートするために、CLR が提供するインターフェイスについて説明します。  
 ...
 プロファイル API で使用されるアンマネージ構造体について説明します。  
  
## <a name="related-sections"></a>関連項目  
 [チュートリアル: パフォーマンスの問題を特定する](/visualstudio/profiling/walkthrough-identifying-performance-problems)  
 Microsoft Visual Studio 2005 Team System で組み込みのプロファイリング ツールを使用する方法について説明します。 これらのツールは、プロファイル API を使用して他の方法を提供します。
