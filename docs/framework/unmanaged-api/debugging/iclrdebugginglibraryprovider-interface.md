...
|メソッド|説明|  
|------------|-----------------|  
|[ProvideLibrary メソッド](../../../../docs/framework/unmanaged-api/debugging/iclrdebugginglibraryprovider-providelibrary-method.md)|により、デバッガーはデバッグ ライブラリの読み込みに使用できるモジュールへのハンドルを提供します。|  
