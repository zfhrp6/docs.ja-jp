...
"ICorDebugEnum"メソッドを実装して、"ICorDebugType"配列を列挙します。  
  
## <a name="methods"></a>メソッド  
  
|メソッド|説明|  
|------------|-----------------|  
|[Next メソッド](../../../../docs/framework/unmanaged-api/debugging/icordebugtypeenum-next-method.md)|指定した数を取得`ICorDebugType`列挙体の現在位置からのインスタンス。|  
