...
## <a name="see-also"></a>関連項目  
 ...
 [WCF サービスのパフォーマンスを制御する ServiceThrottlingBehavior の使用](../../../../../docs/framework/wcf/feature-details/using-servicethrottlingbehavior-to-control-wcf-service-performance.md)
