---
title: "&lt;endpoint&gt; 要素 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|listenUriMode|リッスンするサービスに提供される `ListenUri` をトランスポートが処理する方法を指定します。  有効な値は、次のとおりです。<br /><br /> -   Explicit<br />-   ユニーク<br /><br /> 既定値は Explicit です。|  
