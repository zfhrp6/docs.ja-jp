...
######## [<add>の<defaultPorts>](add-of-defaultports.md)
...
##### [メッセージのエンコード](message-encoding.md)
...
####### [<connectionPoolSettings>の<namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add>の<namespaceTable>](add-of-namespacetable.md)
