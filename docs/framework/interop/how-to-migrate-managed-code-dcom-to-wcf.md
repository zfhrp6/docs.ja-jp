---
title: "方法: マネージ コード DCOM を WCF に移行する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### 値渡しのオブジェクトを送信するクライアントにコードを追加する  
...
### 手順 1: セッションフル WCF サービスのインターフェイスと実装を定義する  
