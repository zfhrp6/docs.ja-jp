---
title: "方法: プライマリ相互運用機能アセンブリを登録する | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
クラスは、COM 相互運用でのみマーシャリングすることができ、常にインターフェイスとしてマーシャリングされます。  場合によっては、クラスをマーシャリングするために使用されるインターフェイスが、クラス インターフェイスと呼ばれます。  クラス インターフェイスを任意のインターフェイスでオーバーライドする方法のについて詳しくは、「詳細については、[COM 呼び出し可能ラッパー](../../../docs/framework/interop/com-callable-wrapper.md)」を参照してください。  
...
## 参照  
 ...
 [Locating Primary Interop Assemblies](http://msdn.microsoft.com/ja-jp/d6768e4b-cd80-414d-a4f8-05d979eb393b)   
 [Redistributing Primary Interop Assemblies](http://msdn.microsoft.com/ja-jp/e76384f0-d631-474c-bdbd-13884cba0265)