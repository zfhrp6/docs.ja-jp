...
-   開発者は、独自のタグ セットを自由に作成できます。  タグのセットには、推奨のものがあります \(このトピックの「関連項目」を参照してください\)。  推奨されるタグには、次のような特殊な意味を持つタグがあります。  
    ...
    -   \<summary\> タグは、[!INCLUDE[vsprvs](../../../csharp/includes/vsprvs_md.md)] で型またはメンバーについての追加的な情報を表示するために、IntelliSense によって使用されます。  
