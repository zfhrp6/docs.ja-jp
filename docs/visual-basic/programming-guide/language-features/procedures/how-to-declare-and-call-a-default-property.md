...
*既定のプロパティ* は、コードで指定しなくてもアクセスできる、クラスまたは構造体のプロパティです。  呼び出し元のコードでクラスや構造体を指定し、プロパティを指定しなければ、コンテキストにおいてプロパティへのアクセスが許可された場合に [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] がそのクラスや構造体の既定のプロパティ \(存在する場合\) にアクセスを解決します。  
