...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] には、数値や文字を対象としないデータ型が用意されています。  これらのデータ型では、Yes\/No 型や日付\/時刻型、およびオブジェクト アドレスなどの特殊なデータが処理されます。  
