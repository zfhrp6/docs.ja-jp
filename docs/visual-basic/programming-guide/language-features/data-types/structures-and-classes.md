...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] では、構造体とクラスの構文が統一され、両方のエンティティでほとんど同じ機能がサポートされるようになりました。  ただし、構造体とクラスの間には重要な違いもあります。  
