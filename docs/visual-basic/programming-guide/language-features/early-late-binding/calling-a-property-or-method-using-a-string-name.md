 ...
 *Result* \= `CallByName`\(*Object*, *ProcedureName*, *CallType*, *Arguments*\(\)\)  
 ...
 `CallByName` 関数は、現在のソリューションのクラスに対して使用できますが、一般的には、COM オブジェクトまたは [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)] アセンブリのオブジェクトにアクセスするときに使用します。  
