...
## 信頼性の高いプログラミング  
 <xref:System.String.Chars%2A> プロパティは、指定された位置にある文字を返します。  ただし、Unicode 文字は複数の文字で表現される場合もあります。  Unicode 文字の詳細については、「[How to: Convert a String to an Array of Characters](../Topic/How%20to:%20Convert%20a%20String%20to%20an%20Array%20of%20Characters%20in%20Visual%20Basic.md)」を参照してください。  
