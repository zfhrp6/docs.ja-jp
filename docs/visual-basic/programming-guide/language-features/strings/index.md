...
ここでは、[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] における文字列の使用に関する基本概念を説明します。  
  
## このセクションの内容  
 [Introduction to Strings in Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/introduction-to-strings.md)  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] における文字列の使用に関する基本的な考え方について説明したトピックをいくつか紹介します。  
 ...
 Triple Data Encryption Standard\) アルゴリズムの暗号化サービス プロバイダーのバージョンを使用して文字列を暗号化および復号化する方法を示します。  
