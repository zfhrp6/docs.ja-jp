...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [Visual Basic における文字列のカルチャの影響](../../../../visual-basic/programming-guide/language-features/strings/how-culture-affects-strings.md)  
 説明方法[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]カルチャ文字列の変換との比較を実行する情報を使用します。  
