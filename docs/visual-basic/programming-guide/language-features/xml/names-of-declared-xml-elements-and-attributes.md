...
## 名前の大文字と小文字の区別  
 XML 要素名では、大文字と小文字が区別されます。  したがって、大文字と小文字のみが異なる 2 つの名前を、[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] コンパイラは異なる名前として解釈します。  たとえば、`ABC` と `abc` は、異なる要素を参照するものとして解釈されます。  
