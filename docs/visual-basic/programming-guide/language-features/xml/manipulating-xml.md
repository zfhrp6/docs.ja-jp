...
*XML リテラル*を使用して、文字列、ファイル、ストリームなどの外部ソースから XML を読み込むことができます。  その後は、[!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] を使用して XML を操作し、[!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext-md.md)] を使用して XML を照会できます。  
...
## このセクションの内容  
 ...
 テキスト ファイル、文字列、またはストリームから <xref:System.Xml.Linq.XDocument> オブジェクトまたは <xref:System.Xml.Linq.XElement> オブジェクトに XML を読み込む方法を示します。  
...
## 関連項目  
 ...
 Visual Basic で XML 要素または XML ドキュメントの一部にアクセスする方法を示します。  
