...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] における XML リテラルの構文は、XML \(Extensible Markup Language\) 1.0 仕様の大部分をサポートします。  XML 1.0 仕様の詳細については、W3C Web サイトの「[Extensible Markup Language \(XML\) 1.0](http://go.microsoft.com/fwlink/?LinkId=73927)」を参照してください。  
