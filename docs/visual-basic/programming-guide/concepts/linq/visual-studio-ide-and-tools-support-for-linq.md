...
## <a name="object-relational-designer"></a>Object Relational Designer  
 使用できるビジュアル デ ザイン ツールは、オブジェクト リレーショナル デザイナーが[LINQ to SQL](../../../../../docs/framework/data/adonet/sql/linq/index.md)を基になるデータベースのリレーショナル データを表すクラスを生成する Visual Basic でのアプリケーションです。 詳しくは、「[Visual Studio の LINQ to SQL ツール](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)」をご覧ください。  
