---
title: "チュートリアル: 遅延実行 (Visual Basic) |Microsoft ドキュメント"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|トピック|説明|  
|-----------|-----------------|  
|[遅延実行とレイジー評価 linq to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)|遅延実行とレイジー評価の概念について説明します。|  
