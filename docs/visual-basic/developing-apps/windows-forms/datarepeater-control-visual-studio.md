...
---
# <a name="datarepeater-control-visual-studio"></a>DataRepeater コントロール (Visual Studio)
Visual Basic Power Packs の <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> コントロールは、データベース テーブルの行などの繰り返されるデータを表示するコントロールの、スクロール可能なコンテナーです。 データのレイアウトを詳細に制御する必要がある場合は、 <xref:System.Windows.Forms.DataGridView> コントロールの代わりにこのコントロールを使用できます。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 `DataRepeater` コントロールを使用してデータ ソースのデータを表示する方法について説明します。  
 ...
 `DataRepeater` コントロールを使用して追加データを表示する方法について説明します。  
 ...
 `DataRepeater` コントロールの方向を変更する方法について説明します。  
 ...
 デザイン時および実行時に `DataRepeater` コントロールをカスタマイズする方法について説明します。  
 ...
 `DataRepeater` コントロールの選択インジケーターを制御する方法について説明します。  
 ...
 `DataRepeater` コントロールでユーザーが項目の追加または削除を行えないようにする方法について説明します。  
 ...
 `DataRepeater` コントロールに検索機能を実装する方法について説明します。  
 ...
 2 つの `DataRepeater` コントロールを使用して関連データを表示する方法について説明します。  
 ...
 `DataRepeater` コントロールの使用方法の全体を示します。  
