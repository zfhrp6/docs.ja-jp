...
## <a name="to-correct-this-error"></a><span data-ttu-id="98ecb-105">このエラーを解決するには</span><span class="sxs-lookup"><span data-stu-id="98ecb-105">To correct this error</span></span>  
  
1.  <span data-ttu-id="98ecb-106">プロパティを調べて、どのような条件でプロパティを設定できるかを確認します。</span><span class="sxs-lookup"><span data-stu-id="98ecb-106">Check the property and determine under what conditions it can be set.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="98ecb-107">関連項目</span><span class="sxs-lookup"><span data-stu-id="98ecb-107">See Also</span></span>  
 [<span data-ttu-id="98ecb-108">プロジェクトおよびソリューションのプロパティの管理</span><span class="sxs-lookup"><span data-stu-id="98ecb-108">Managing Project and Solution Properties</span></span>](/visualstudio/ide/managing-project-and-solution-properties)
