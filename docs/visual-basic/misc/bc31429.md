...
---
# <a name="39ltelementnamegt39-is-ambiguous-because-multiple-kinds-of-members-with-this-name-exist-in-lttypegt-39lttypenamegt39"></a>'&lt;elementname&gt;' に複数の種類のこの名前を持つメンバーが存在するためには、あいまい&lt;型&gt;'&lt;typename&gt;'
