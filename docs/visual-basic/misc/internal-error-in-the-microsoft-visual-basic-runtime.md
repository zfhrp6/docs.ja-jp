---
title: "Microsoft Visual Basic ランタイムの内部エラー |Microsoft ドキュメント"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
Microsoft で内部エラーが発生しました[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]ランタイム。  
