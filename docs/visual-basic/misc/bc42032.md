...
---
# <a name="operands-of-type-object-used-for-operator-39ltoperatorsymbolgt39-use-the-39isnot39-operator-to-test-object-identity"></a>演算子のオブジェクトが使用される型のオペランド '&lt;operatorsymbol&gt;'; 'IsNot' 演算子を使用して、オブジェクト id をテストするには
式を使用して、`<>`演算子の一方または両方のオペランドを指定して、 [Object データ型](../../visual-basic/language-reference/data-types/object-data-type.md)します。  
