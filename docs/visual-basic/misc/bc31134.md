...
---
# <a name="39addhandler39-and-39removehandler39-method-parameters-cannot-be-declared-39byref39"></a>'ByRef' 'AddHandler' と 'RemoveHandler' メソッドのパラメーターを宣言することはできません。
