---
title: "ローカル コンピューターに登録されていないクラス |Microsoft ドキュメント"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
このエラーは通常、ファイルが破損している場合に発生します。 再インストールする必要があります[!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)]します。  
  
## <a name="to-correct-this-error"></a>このエラーを解決するには  
  
-   再インストール[!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)]します。  
