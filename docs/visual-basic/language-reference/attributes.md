...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]オブジェクトが、アンマネージ コードと相互運用できるようにするいくつかの属性とモジュール名を指定せずにアクセスしてモジュール メンバーを使用できる 1 つの属性を提供します。 次の表で使用される属性[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]です。  
...
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute>|構造体または非ローカル変数の配列を固定長の配列として扱うことを示します。|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute>|固定長かのように文字列を扱うことを示します。|  
