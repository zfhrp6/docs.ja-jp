...
## 解説  
 `<para>` タグは、[\<summary\>](../Topic/%3Csummary%3E%20\(Visual%20Basic\).md)、[\<remarks\>](../Topic/%3Cremarks%3E%20\(Visual%20Basic\).md)、[\<returns\>](../../../visual-basic/language-reference/xmldoc/returns.md) などのタグの中で使用され、テキストに構造体を追加します。  
