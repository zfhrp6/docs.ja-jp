...
Visual Basic で定義されている算術演算子を次に示します。  
 ...
 [+ 演算子](../../../visual-basic/language-reference/operators/addition-operator.md)(単項やバイナリ)  
  
 [-演算子](../../../visual-basic/language-reference/operators/subtraction-operator.md)(単項やバイナリ)  
