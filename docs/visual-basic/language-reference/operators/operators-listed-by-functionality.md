...
以下のカテゴリのいずれかを参照するか、ヘルプの目次のアルファベット順の一覧を表示するには、この部分を開いて[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]演算子。  
...
|[論理/ビット演算子](../../../visual-basic/language-reference/operators/logical-bitwise-operators.md)|これらの演算子は、各論理操作を実行します。|  
