...
以下のカテゴリのいずれかを参照するか、ヘルプの目次のこの部分を開いて [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] の演算子のアルファベット順のリストを表示します。  
  
## 演算子のカテゴリ  
  
|演算子|Description|  
|---------|-----------------|  
|[算術演算子](../../../visual-basic/programming-guide/language-features/operators-and-expressions/arithmetic-operators.md)|算術演算を行います。|  
...
|[連結演算子](../../../visual-basic/programming-guide/language-features/operators-and-expressions/concatenation-operators.md)|文字列連結演算を行います。|  
