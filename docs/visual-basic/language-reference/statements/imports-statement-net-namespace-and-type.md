...
> [!NOTE]
>  [\[参照設定\] ページ \(プロジェクト デザイナー\) \(Visual Basic\)](/visual-studio/ide/reference/references-page-project-designer-visual-basic) を使用して、暗黙的な `Imports` ステートメントを定義できます。  詳細については、「[方法 : インポートした名前空間を追加または削除する \(Visual Basic\)](../Topic/How%20to:%20Add%20or%20Remove%20Imported%20Namespaces%20\(Visual%20Basic\).md)」を参照してください。  
