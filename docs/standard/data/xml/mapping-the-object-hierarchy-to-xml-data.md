---
title: "オブジェクト階層の XML データへのマップ | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
```  
 ...
 ![サンプル ノード ツリー](../../../../docs/standard/data/xml/media/simple-xml.gif "Simple\_XML")  
book と title のノード ツリー表現  
  
 `book` 要素と  **要素は `title`XmlElement** になり、要素コンテンツは **XmlText** オブジェクトになります。  **XmlElement** のメソッドとプロパティは、**XmlText** オブジェクトで使用できるメソッドとプロパティとは異なります。  実行可能なアクションはノード型によって決定されるため、XML マークアップがどのノード型になるかを理解することがきわめて重要です。  
