...
- `System.Collections.Generic.NonRandomizedStringEqualityComparer`<!--zz <xref:System.Collections.Generic.NonRandomizedStringEqualityComparer?displayProperty=fullName> --> (.NET Core 2.0.4 とそれ以降のバージョンで使用可能)
...
- `System.Diagnostics.Contracts.ContractException`<!--zz <xref:System.Diagnostics.Contracts.ContractException?displayProperty=fullName> --> (.NET Core 2.0.4 とそれ以降のバージョンで使用可能)
...
- `System.IO.Compression.ZLibException`<!--zz <xref:System.IO.Compression.ZLibException?displayProperty=fullName --> (.NET Core 2.0.4 とそれ以降のバージョンで使用可能)
...
- `System.Security.Cryptography.Xml.CryptoSignedXmlRecursionException`<!--zz <xref:System.Security.Cryptography.Xml.CryptoSignedXmlRecursionException?displayProperty=fullName --> (.NET Core 2.0.4 とそれ以降のバージョンで使用可能)
