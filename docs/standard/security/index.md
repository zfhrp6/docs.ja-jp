---
title: ".NET Framework におけるセキュリティ | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  ...
  - "アプリケーション開発 [.NET Framework], セキュリティ"
  - "セキュリティ [.NET Framework]"
...
## このセクションの内容  
 ...
 .NET Framework セキュリティ システムの重要な変更について説明します。  
 ...
 .NET Framework によって提供される暗号サービスの概要を説明します。 このセクションは開発者を対象としています。  
  
 [安全なコーディングのガイドライン](../../../docs/standard/security/secure-coding-guidelines.md)  
 信頼できる .NET Framework アプリケーションを作成するときの最適な実施方法について説明します。 このセクションは開発者を対象としています。  
