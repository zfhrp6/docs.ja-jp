...
### <a name="to-set-up-this-sample"></a><span data-ttu-id="c9343-112">このサンプルをセットアップするには</span><span class="sxs-lookup"><span data-stu-id="c9343-112">To set up this sample</span></span>  
