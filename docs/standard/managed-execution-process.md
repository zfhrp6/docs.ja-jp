---
title: "マネージ実行プロセス | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  ...
  - "コード, マネージ実行プロセス"
  - "ランタイム, マネージ実行プロセス"
  - "ソース コードのコンパイル, マネージ実行プロセス"
  - "マネージ実行プロセス"
  - "共通言語ランタイム, マネージ実行プロセス"
...
-   .NET Framework [Ngen.exe \(ネイティブ イメージ ジェネレーター\)](../../docs/framework/tools/ngen-exe-native-image-generator.md)。  
