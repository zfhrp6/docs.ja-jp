...
非同期メソッドで [ref](https://msdn.microsoft.com/library/14akc2c7.aspx) パラメーターまたは [out](https://msdn.microsoft.com/library/t3c3bfhx.aspx) パラメーターを宣言することはできませんが、これらのパラメーターを持つメソッドを呼び出すことはできます。
