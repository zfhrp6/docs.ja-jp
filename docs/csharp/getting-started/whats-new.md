 ...
 **式本体を持つ関数メンバー**  
 コードの式本体を持つメンバーを、ラムダ式で使用するのと同じ軽量構文内で宣言することができます。  「[メソッド](../../csharp/programming-guide/classes-and-structs/methods.md)」、「[プロパティ](../../csharp/programming-guide/classes-and-structs/properties.md)」、「[インデクサー](../../csharp/programming-guide/indexers/index.md)」、「[オーバーロードされた演算子](../../csharp/programming-guide/statements-expressions-operators/overloadable-operators.md)」を参照してください。  
