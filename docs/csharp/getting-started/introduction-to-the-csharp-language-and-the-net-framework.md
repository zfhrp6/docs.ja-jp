...
-   C\# 言語の概略については、「[C\# 言語仕様](../../visual-basic/reference/language-specification.md)」の第 1 章を参照してください。  
  
-   C\# 言語の具体的な側面の詳細については、「[C\# リファレンス](../../csharp/language-reference/index.md)」を参照してください。  
  
-   [!INCLUDE[vbteclinq](../../csharp/includes/vbteclinq_md.md)] の詳細については、「[LINQ \(Language\-Integrated Query\)](../Topic/LINQ%20\(Language-Integrated%20Query\).md)」を参照してください。  
