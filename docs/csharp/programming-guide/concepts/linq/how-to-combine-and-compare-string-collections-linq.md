---
title: "方法: 文字列コレクションを結合および比較する (LINQ) (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="compiling-the-code"></a>コードのコンパイル  
 .NET Framework Version 3.5 以降を対象とするプロジェクトを作成します。このプロジェクトには、System.Core.dll への参照設定、System.Linq 名前空間および System.IO 名前空間に対する `using` ディレクティブが含まれます。  
