...
|トピック|説明|  
|-----------|-----------------|  
|[方法: 文字列を解析する (C#) ](../../../../csharp/programming-guide/concepts/linq/how-to-parse-a-string.md)|文字列を解析して XML ツリーを作成する方法について説明します。|  
|[方法: ファイルから XML を読み込む (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-load-xml-from-a-file.md)|<xref:System.Xml.Linq.XElement.Load%2A> メソッドを使用して、URI から XML を読み込む方法について説明します。|  
|[XML の読み込み時または解析時の空白の維持](../../../../csharp/programming-guide/concepts/linq/preserving-white-space-while-loading-or-parsing-xml1.md)|XML ツリーを読み込む際の、空白に対する [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] の動作を制御する方法について説明します。|  
|[方法: 解析エラーをキャッチする (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-catch-parsing-errors.md)|形式が正しくないか無効な XML を検出する方法について説明します。|  
