---
title: "高度な LINQ to XML プログラミング (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|トピック|説明|  
|-----------|-----------------|  
|[LINQ to XML の注釈](../../../../csharp/programming-guide/concepts/linq/linq-to-xml-annotations.md)|[!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] のノードおよび属性に注釈を追加する方法について説明します。|  
...
|[方法: 大きな XML ドキュメントのストリーミング変換を実行する (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)|<xref:System.Xml.XmlReader> から XML をストリーム出力し、XML フラグメントを変換して、<xref:System.Xml.Linq.XStreamingElement> を利用してその出力をストリームする方法について説明します。|  
...
|[XElement オブジェクトを含むオブジェクト グラフのシリアル化 (C#)](../../../../csharp/programming-guide/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)|<xref:System.Xml.Linq.XElement> オブジェクトと <xref:System.Xml.Linq.XDocument> オブジェクトが含まれるオブジェクト グラフをシリアル化する方法について説明します。|  
