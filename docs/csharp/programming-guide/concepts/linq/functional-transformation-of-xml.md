---
title: "XML の関数型変換 (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
### <a name="xml-functional-transformational-technologies"></a>XML の関数型変換のテクノロジ  
 ...
 LINQ to XML とその他の Microsoft XML テクノロジとの比較の詳細については、「[LINQ to XML とその他の XML テクノロジ](../../../../csharp/programming-guide/concepts/linq/linq-to-xml-vs-other-xml-technologies.md)」を参照してください。  
