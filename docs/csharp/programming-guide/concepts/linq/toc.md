...
### [LINQ クエリの概要](introduction-to-linq-queries.md)
### [LINQ とジェネリック型](linq-and-generic-types.md)
### [LINQ クエリの基本操作](basic-linq-query-operations.md)
### [LINQ によるデータ変換](data-transformations-with-linq.md)
### [LINQ クエリ操作での型の関係](type-relationships-in-linq-query-operations.md)
### [LINQ でのクエリ構文とメソッド構文](query-syntax-and-method-syntax-in-linq.md)
### [LINQ をサポートする C# の機能](features-that-support-linq.md)
### [チュートリアル: C# でのクエリの作成 (LINQ)](walkthrough-writing-queries-linq.md)
...
#### [方法: 指定された単語のセットを含む文章を照会する (LINQ)](how-to-query-for-sentences-that-contain-a-specified-set-of-words-linq.md)
