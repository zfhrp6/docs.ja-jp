...
## <a name="see-also"></a>関連項目  
 [チュートリアル: Visual Studio (c#) でのマネージ アセンブリから型の埋め込み](../../../../csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio.md)  
