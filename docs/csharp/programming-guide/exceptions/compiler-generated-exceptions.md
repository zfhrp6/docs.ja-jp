...
|<xref:System.OutOfMemoryException>|[new 演算子](../../../csharp/language-reference/keywords/new-operator.md)を使用してメモリを割り当てようとして失敗した場合にスローされます。  共通言語ランタイムの使用可能なメモリ容量が不足しています。|  
