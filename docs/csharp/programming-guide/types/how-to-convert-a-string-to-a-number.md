...
<xref:System.Convert> クラスのメソッドを使用するか、さまざまな数値型 \(int、long、float など\) にある `TryParse` メソッド使用して、[文字列](../../../csharp/language-reference/keywords/string.md)を数値に変換できます。  
...
## 参照  
 ...
 [.NET Framework 4 の書式指定ユーティリティに関するページ](http://code.msdn.microsoft.com/NET-Framework-4-Formatting-9c4dae8d)