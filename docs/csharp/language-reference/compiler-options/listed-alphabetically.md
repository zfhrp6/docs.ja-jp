---
title: "アルファベット順の C# コンパイラ オプションの一覧 | Microsoft Docs"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
|[/langversion:\<文字列>](../../../csharp/language-reference/compiler-options/langversion-compiler-option.md)|言語バージョンのモード (ISO-1、ISO-2、3、4、5、6、または Default) を指定します。|  
