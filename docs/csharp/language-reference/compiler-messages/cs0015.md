...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="b62af-102">コンパイラ エラー CS0015</span><span class="sxs-lookup"><span data-stu-id="b62af-102">Compiler Error CS0015</span></span>
<span data-ttu-id="b62af-103">型 'type' の名前が長すぎます</span><span class="sxs-lookup"><span data-stu-id="b62af-103">The name of type 'type' is too long</span></span>  
  
 <span data-ttu-id="b62af-104">ユーザー定義型の完全修飾名は、ピリオドを含め、1024 文字以下にする必要があります。</span><span class="sxs-lookup"><span data-stu-id="b62af-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>  
  
 <span data-ttu-id="b62af-105">次の例では CS0015 が生成されます。</span><span class="sxs-lookup"><span data-stu-id="b62af-105">The following sample generates CS0015:</span></span>  
