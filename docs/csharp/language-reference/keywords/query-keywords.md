---
title: "クエリ キーワード (C# リファレンス) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
  - "devlang-csharp"
...
|[where](../../../csharp/language-reference/keywords/where-clause.md)|論理 AND 演算子 \(`&&`\) と論理 OR 演算子 \(`&#124;&#124;`\) で区切られた 1 つ以上のブール式に基づき、ソース要素をフィルター処理します。|  
