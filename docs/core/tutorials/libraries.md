...
2. .NET Framework の参照 1 に取り込む `net40 ` ターゲットの `<ItemGroup>` ノードがあります。
...
> [!INFO] この例ではいくつかの [.NET CLI コマンド](../tools/index.md)を使用しています。  詳細については、「[dotnet new](../tools/dotnet-new.md)」と「[dotnet sln](../tools/dotnet-sln.md)」を参照してください。
