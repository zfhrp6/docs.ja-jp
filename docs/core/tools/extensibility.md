...
> [!WARNING]
> このトピックは .NET Core Tools Preview 2 を対象としています。 .NET Core Tools RC4 バージョンについては、「[.NET Core CLI の拡張モデル (.NET Core Tools RC4)](../preview3/tools/extensibility.md)」トピックを参照してください。
