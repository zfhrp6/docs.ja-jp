...
この記事では、Windows で Visual Studio 2015 以降を使用していると想定しています。  旧バージョンの Visual Studio では、.NET Core コードの構築に必要な機能の一部を使用できません。
...
* [xUnit](https://xunit.github.io/)
   - [はじめに](http://xunit.github.io/docs/getting-started-dnx.html)
