...
### [CLI の変更概要](core/preview3/tools/layering.md)
### [依存関係管理](core/preview3/tools/dependencies.md)
### [アプリケーションの配置](core/preview3/deploying/index.md)
...
### [継続的インテグレーション](core/preview3/tools/using-ci-with-cli.md)
